...
class DialogueChoice {
	...
	var is_plot_point : boolean;
	var aspect : String;
	var good_ending : boolean;
...
function ShowList () {
	...
	for (var c in display.choices) {
		...
		/*This is where the player presses the button in a dialogue. Some options are simple 
		  dialogue , however at some point the player will have to make some choices , so what he 
		  chooses will matter.
		  
		  We added 3 variables to each Dialogue Option
		  
		  - is_plot_point
		  - The aspect it is about ("Domestic" etc...)
		  - Whether the choice is a good or a bad ending
		  
		  Every time the player presses a button there is a check whether that dialogue option 
		  is a "plot point". If it is there are further checks on whether the option he chose is a good or 
